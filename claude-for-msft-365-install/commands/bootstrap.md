...
moment you want Salesforce CRM for one team and Gainsight for another, you're here.
...
| `mcp_servers[].url` | The MCP server itself. Public ones (Salesforce, HubSpot) already allow it. Internal ones almost certainly don't until you add it. |
...
```json
"mcp_servers": [
  { "url": "https://mcp.salesforce.com/sse", "label": "Salesforce CRM" },
  {
    "url": "https://internal.yourcompany.com/mcp/gainsight",
    "label": "Gainsight",
...
"skills": [
  {
    ...
    "url": "https://yourbucket.s3.amazonaws.com/skills/account-health-summary.zip?X-Amz-..."
  },
  {
    "name": "renewal-risk-brief",
    "content": "IyBSZW5ld2FsIHJpc2sgYnJpZWYKCkFuYWx5emUgdGhlIGFjY291bnQgZm9yIHJlbmV3YWwgcmlzay4uLg=="
  }
]
```
